  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="Planning and strategy is the first step in the development process. It involves creating a roadmap, defining the objectives, and setting the scope of the project."
        ...
        description="Development and progress update is the second step in the development process. It involves creating a roadmap, defining the objectives, and setting the scope of the project."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="Development and launch is the third step in the development process. It involves creating a roadmap, defining the objectives, and setting the scope of the project."
        >
          <CanvasRevealEffect
            animationSpeed={3}
